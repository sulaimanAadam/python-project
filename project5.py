...
def ask_question(question):
    ...
    if number < 1 or number > len(question["option"]):
     print("invalid choice, defaulting to wrong answer")
     return False

    correct = question["option"][number -1] == question["answer"]
    return correct        

questions = load_questions()
total_question = int(input("Enter the number of questions: "))
random_questions = get_random_questions(questions, total_question)
correct = 0
